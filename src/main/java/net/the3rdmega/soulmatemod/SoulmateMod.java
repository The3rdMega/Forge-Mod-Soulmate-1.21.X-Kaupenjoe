package net.the3rdmega.soulmatemod;
...
@Mod(SoulmateMod.MOD_ID)
public class SoulmateMod
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "soulmatemod";
    ...
    // Adiciona Itens ou blocos para a aba do inventário criativo
